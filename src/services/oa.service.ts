...
export async function sendOANotification({ userId, productName }: { userId: string; productName: string }) {
  // Giả lập gửi thông báo OA (ở đây chỉ log, thực tế sẽ gọi API OA)
  // TODO: Thay thế bằng API thật nếu có
  console.log(`[OA] Đã gửi thông báo OA cho userId: ${userId} về sản phẩm: ${productName}`);
